...
public class RoomBookingUIFromFile {
    private final Service keepFromFileService;
    private Person customerPerson;

    public RoomBookingUIFromFile(Service fromFile) {
        this.keepFromFileService = fromFile;
    }
    ...
    private void uiRegisterPerson() {
        ...
        keepFromFileService.registerPerson(name, email, password);
    ...
    private void uiListAllRooms() {
        var rooms = keepFromFileService.getAllRooms();
            ...
            if (ans.hasNext("[1|2]")) {
                ...
                switch (i) {
                    case 1:
                        ...
                        Room room = keepFromFileService.getRoom(roomNumber);
                        if (room == null) {
                        ...
                        Reservation reservation = keepFromFileService.createRoomReservation(customerPerson, room);
                        if(reservation != null){
            ...
            if (ans.hasNext("[1|2]")) {
                ...
                switch (i) {
                    case 1 -> {
                        ...
                        var myReservation = keepFromFileService.getMyReservation(customerPerson.getPersonId());
            ...
            if (ans.hasNext("[1|2]")) {
                ...
                switch (i) {
                    case 1:
                        ...
                        Reservation reservation = keepFromFileService.getReservationById(reservationID);
                        if(reservation == null){
                        ...
                        keepFromFileService.cancelReservation(reservation, customerPerson);
                        uiViewMenu();
                        break;
                    case 2:
                        uiViewMenu();
