...
public class RoomBookingUIFromMemory {
    private final Service keepFromMemoryService;
    private Person customerPerson;

    public RoomBookingUIFromMemory(Service fromMemory) {
        this.keepFromMemoryService = fromMemory;
    }
    ...
    private void uiRegisterPerson() {
        ...
        keepFromMemoryService.registerPerson(name, email, password);
    ...
    private void uiListAllRooms() {
        var rooms = keepFromMemoryService.getAllRooms();
            ...
            if (ans.hasNext("[1|2]")) {
                ...
                switch (i) {
                    case 1:
                        ...
                        Room room = keepFromMemoryService.getRoom(roomNumber);
                        if (room == null) {
                        ...
                        Reservation reservation = keepFromMemoryService.createRoomReservation(customerPerson, room);
                        if(reservation != null){
            ...
            if (ans.hasNext("[1|2]")) {
                ...
                switch (i) {
                    case 1 -> {
                        ...
                        var myReservation = keepFromMemoryService.getMyReservation(customerPerson.getPersonId());
            ...
            if (ans.hasNext("[1|2]")) {
                ...
                switch (i) {
                    case 1:
                        ...
                        keepFromMemoryService.cancelReservation(reservation, customerPerson);
